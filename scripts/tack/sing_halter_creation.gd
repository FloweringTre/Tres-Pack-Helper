...
func _save_tack() -> void:
	...
	if text_render:
		render_save_path = save_path + "/" + GlobalScripts.text_clean(%tackText.text) + "_halter_legacy.png"
	...
	if text_rack:
		rack_save_path = save_path + "/rack_halter_lead_" + GlobalScripts.text_clean(%tackText.text) + "_halter.png"
...
func on_new_tack_saved() -> void:
	var title = "Complete!"
	var message = "Successfully added '" + %tackText.text + " Halter' to the pack folder. \nWhat do you want to do now?"
