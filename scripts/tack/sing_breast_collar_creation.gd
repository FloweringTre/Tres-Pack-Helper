...
func _save_tack() -> void:
	...
	if text_icon:
		icon_save_path = save_path + "/" + GlobalScripts.text_clean(%tackText.text) + "_breast_collar_icon.png"
	...
	if text_render:
		render_save_path = save_path + "/" + GlobalScripts.text_clean(%tackText.text) + "_breast_collar_legacy.png"
...
func on_new_tack_saved() -> void:
	var title = "Complete!"
	var message = "Successfully added '" + %tackText.text + " Breast Collar' to the pack folder. \nWhat do you want to do now?"
